...
namespace NonStandard.GameUi {
	public class CollisionRules : MonoBehaviour {
		...
		[System.Serializable]
		public class CollisionTagEditor {
			...
			public void __Write() {
				...
				NonStandard.Utility.File.RewriteAssetCSharpFile(TagEnumName + ".cs", fileData, new string[] { "NonStandard.GameUi.Generated" });
			}
